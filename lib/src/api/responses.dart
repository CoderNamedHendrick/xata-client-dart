...
class AuthError {
	...
	const AuthError({this.id,required this.message,});
...
class BadRequestError {
	final String? id;
	final String message;
	const BadRequestError({this.id,required this.message,});
	Map<String, dynamic> toJson() => {
		'id' : id,
		'message' : message,
	};
...
class BranchMigrationPlan {
	...
	factory BranchMigrationPlan.fromJson(Map<String, dynamic> json) => BranchMigrationPlan(
		...
		migration: BranchMigration.fromJson(json["migration"]),
	);
...
class QueryResponse {
	...
	factory QueryResponse.fromJson(Map<String, dynamic> json) => QueryResponse(
		...
		meta: RecordsMetadata.fromJson(json["meta"]),
	);
...
class SimpleError {
	final String? id;
	final String message;
	const SimpleError({this.id,required this.message,});
	Map<String, dynamic> toJson() => {
		'id' : id,
		'message' : message,
	};
